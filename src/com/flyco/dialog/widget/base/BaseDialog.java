...
public abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
    ...
    public void onAttachedToWindow() {
        ...
        LinearLayout.LayoutParams bprms = new LinearLayout.LayoutParams(width, height);
        bprms.leftMargin = hMargin;
        bprms.rightMargin = hMargin;
        bprms.topMargin = vMargin;
        bprms.bottomMargin = vMargin;
        mLlControlHeight.setLayoutParams(bprms);
    ...
    public T hMargin(int hm) {
        hMargin = hm;
        return (T) this;
    }

    public T vMargin(int vm) {
        vMargin = vm;
        return (T) this;
    }
